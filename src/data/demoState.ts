...
export const scenarios: Scenario[] = [
  {
    ...
    radiationSensitivity: 38,
    confidenceSensitivity: 48,
    expectedDataReduction: 16,
    blockedGroundStationIds: ['alaska-optical'],
  ...
  },
  {
    ...
    freshnessMinutes: 30,
    deadlinePressure: 72,
    thermalSensitivity: 36,
    contactSensitivity: 42,
    radiationSensitivity: 88,
    confidenceSensitivity: 76,
    expectedDataReduction: 14,
  ...
  },
  {
    ...
    deadlinePressure: 24,
    thermalSensitivity: 58,
    contactSensitivity: 54,
    radiationSensitivity: 28,
    confidenceSensitivity: 32,
    expectedDataReduction: 8,
    blockedGroundStationIds: [],
...
export const policyVersions: PolicyVersion[] = [
  {
    ...
    guardrails: ['label seeded telemetry', 'make no real satellite control claims'],
  ...
  },
  {
    ...
    guardrails: ['label seeded telemetry', 'make no real satellite control claims', 'show confidence limits'],
