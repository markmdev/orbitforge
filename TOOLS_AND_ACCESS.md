...
- Confirmation that the Gemini runtime routes used by the app can call the
  Interactions API. The Gemini Antigravity IDE is not required, and
  development-time AGENTS/SKILL files are not part of the app plan.
