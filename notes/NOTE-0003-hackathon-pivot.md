# NOTE-0003 - Hackathon Pivot

Date: 2026-06-27

Mark supplied hackathon requirements after the initial domain research. The
project now targets overall first place and Best Usage of Gemini 3.5.

Decision captured in `ADRs/ADR-0001-gemini-self-improving-orbital-ops.md`:

- product name: OrbitForge;
